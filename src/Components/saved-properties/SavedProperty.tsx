...
import Sell from "@/Components/icons/sel;.svg";
    ...
    <div className="">
      ...
      <div className="flex justify-between items-center mt-12 max-md:mt-8 max-lg:flex-col max-lg:gap-5 mb-6">
        <div className=" flex  border-2 rounded-md border-navy-blue px-1 py-1 bg-low-red max-lg:w-full max-lg:justify-between">
          ...
          >
            <Image width={50} height={30} className='h-auto w-auto' src={Rent} alt="Rent Image" />
          ...
          >
            <Image width={50} height={30} className='h-auto w-auto' src={Buy} alt="Buy Image" />
            <p>Buy</p>
          </div>
          <div
            onClick={all}
          ...
          >
            <Image width={50} height={30} className='h-auto w-auto' src={Sell} alt="All Image" />
            <p>All</p>
          </div>
        </div>
        ...
        max-lg:w-full"
        >
          <Image width={50} height={30} className='h-auto w-auto' src={Search} alt="Search Icon" />
          <input
            type="search"
