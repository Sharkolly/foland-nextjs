          ...
          {properties?.map(({ property }, index) => {
            return (
              ...
              >
                ...
                >
                  {property?.images?.map((image: imageType, index: number) => (
                    <Link
                ...
                <div className="px-9 my-6 max-md:px-4 max-xl:px-6">
                  ...
                  >
                    <div className="flex gap-2 max-md:gap-1 items-center">
                      <Image
                      width={40}
                      height={25} src={Bed} alt="Bed Icon" />
                    ...
                    <div className="flex gap-2 max-md:gap-1 items-center">
                      <Image
                      width={40}
                      height={25} src={BathRoom} alt="Bathroom Icon" />
                      <p className="max-md:text-[.8em]">
                    ...
                    <div className="flex gap-2 max-md:gap-1 items-center max-sm:hidden">
                      <Image
                      width={40}
                      height={25} src={SquareMeter} alt="Square Meteres Icons" />
                      <p className="max-md:text-[.8em]">
                        {property?.landSize}
