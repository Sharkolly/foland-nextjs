...
const Footer = () => {
  ...
  return (
    <div>
      <div className="border-t-2 border-navy-blue z-[600]">
        <div className="w-10/12 mx-auto text-navy-blue my-16 flex justify-between max-lg:w-[91%] max-md:flex-col max-md:gap-10 max-md:my-10">
          ...
          <div className="flex-col flex gap-14 max-md:flex-row max-md:gap-14 max-md:border-b-2 max-md:pb-7 max-md:border-slate-100 max-sm:gap-8">
            <div>
          ...
          <div className="flex-col flex gap-12 max-md:border-b-2 max-md:pb-7 max-md:border-slate-100">
            <div>
        ...
        <div className="">
          <hr className="w-full h-[2px] text-slate-400 pb-7 max-md:hidden" />

          <div className="w-9/12 mx-auto max-md:w-[91%] flex justify-between max-md:flex-col max-md:gap-5 max-md:items-center pb-10 max-md:pb-32">
            <div className="text-slate-400 max-sm:text-[.9em]">
              <p>&copy;2025 Foland Realty. All rights reserved.</p>
            </div>

            <div className="text-slate-400 text-2xl flex gap-10 max-lg:gap-7 items-center max-md:text-xl ">
